...
-- Retrieval info:  <NETLIST_SECTION active_core="My_NCO_st" >
...
-- Retrieval info:      <PRIVATE name = "FREQ_VALUE" value="25"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "MODULE_NAME" value="My_NCO_st"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "NETLIST_FILE_NAME" value="My_NCO_st.v"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "RCFC" value="My_NCO_cos_c.mif"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RCVC" value="My_NCO_cos_c.v"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RCHC" value="My_NCO_cos_c.hex"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RCFF" value="My_NCO_cos_f.mif"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RCVF" value="My_NCO_cos_f.v"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RCHF" value="My_NCO_cos_f.hex"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RSFC" value="My_NCO_sin_c.mif"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RSVC" value="My_NCO_sin_c.v"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RSHC" value="My_NCO_sin_c.hex"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RSFF" value="My_NCO_sin_f.mif"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RSVF" value="My_NCO_sin_f.v"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RSHF" value="My_NCO_sin_f.hex"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "NUM_LCELLS" value="2541"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "PHI_INC" value="1073742"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
-- Retrieval info:     <NAMESPACE name = "simgen_enable">
-- Retrieval info:      <PRIVATE name = "language" value="VHDL"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
-- Retrieval info:     <NAMESPACE name = "simgen">
-- Retrieval info:      <PRIVATE name = "filename" value="My_NCO.vho"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
-- Retrieval info:     <NAMESPACE name = "greybox">
-- Retrieval info:      <PRIVATE name = "filename" value="My_NCO_syn.v"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
